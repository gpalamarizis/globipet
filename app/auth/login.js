    ...
    return (<react_native_1.KeyboardAvoidingView style={styles.container} behavior={react_native_1.Platform.OS === 'ios' ? 'padding' : 'height'}>
      <react_native_1.View style={styles.inner}>
        ...
        <react_native_1.View style={styles.form}>
          ...
          <react_native_1.TextInput style={styles.input} placeholder="Κωδικός" value={password} onChangeText={setPassword} secureTextEntry placeholderTextColor="#9CA3AF"/>
          ...
          <react_native_1.TouchableOpacity style={styles.socialButton}>
