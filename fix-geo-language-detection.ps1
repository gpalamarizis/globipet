...
export default i18n
'@
Set-Content -Path (Join-Path $root "apps\web\src\lib\i18n.ts") -Value $f1 -Encoding UTF8 -NoNewline
...
'@
Set-Content -Path (Join-Path $root "apps\web\src\lib\geoLocale.ts") -Value $f2 -Encoding UTF8 -NoNewline
Write-Host "OK: apps\web\src\lib\geoLocale.ts"

Write-Host "Done — geo-IP language detection wired in."