...
exports.detectAndApplyGeoLanguage = detectAndApplyGeoLanguage;
var COUNTRY_TO_LANG = {
    // Greek
    GR: 'el', CY: 'el',
    // Spanish
...
function detectAndApplyGeoLanguage(i18nInstance) {
    return __awaiter(this, void 0, void 0, function () {
        var res, text, match, country, lang, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch('/cdn-cgi/trace')];
                case 2:
                    res = _b.sent();
                    if (!res.ok)
                        return [2 /*return*/];
                ...
                case 3:
                    text = _b.sent();
                    match = text.match(/loc=([A-Z]{2})/);
                    country = match === null || match === void 0 ? void 0 : match[1];
                    if (!country)
                        return [2 /*return*/];
