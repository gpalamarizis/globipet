...
const SERVICES = [
  ...
  { icon: Shield, title: 'Ιατρικός Φάκελος', desc: 'Πλήρες ψηφιακό ιστορικό υγείας — εμβόλια, εξετάσεις, φάρμακα, χειρουργεία. Διαθέσιμο οποτεδήποτε, παντού.', color: 'bg-orange-50 text-orange-600', img: 'https://images.unsplash.com/photo-1548767797-d8c844163c4a?w=600&q=80' },
