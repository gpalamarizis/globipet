...
function ResetPassword() {
    ...
    var _c = (0, react_1.useState)(false), showPass = _c[0], setShowPass = _c[1];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, api_1.api.post('/auth/reset-password', { token: token, password: password })];
                case 2:
                    _c.sent();
                    react_hot_toast_1.default.success(t('authExtraLogin.passwordReset'));
                    navigate('/login');
                    return [3 /*break*/, 5];
                case 3:
                    err_1 = _c.sent();
