...
import { Home, Heart, ShoppingBag, Scissors, Search, Bell, ShoppingCart, Menu, X, ChevronDown, Stethoscope, MapPin, Shield, LogOut, Brain, BookOpen, PawPrint } from 'lucide-react'
