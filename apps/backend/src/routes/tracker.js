...
var routes = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prisma_js_1.default.petLocation.findMany({
        ...
        app.post('/', { preHandler: [app.authenticate] }, function (req, reply) { return __awaiter(void 0, void 0, void 0, function () {
            var email, _a, pet_id, latitude, longitude, status, location;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        email = req.user.email;
                        _a = req.body, pet_id = _a.pet_id, latitude = _a.latitude, longitude = _a.longitude, status = _a.status;
                        if (!pet_id || !latitude || !longitude)
                            return [2 /*return*/, reply.code(400).send({ message: 'Λείπουν υποχρεωτικά πεδία' })];
                        return [4 /*yield*/, prisma_js_1.default.petLocation.create({
                                data: { pet_id: pet_id, owner_email: email, latitude: parseFloat(latitude), longitude: parseFloat(longitude), status: status || 'safe' }
                            })];
                    case 1:
                        location = _b.sent();
                        return [2 /*return*/, reply.code(201).send({ data: location })];
                }
            });
        }); });
        app.patch('/:id', { preHandler: [app.authenticate] }, function (req, reply) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = req.user.email;
                        return [4 /*yield*/, prisma_js_1.default.petLocation.findUnique({ where: { id: req.params.id } })];
                    case 1:
                        existing = _a.sent();
                        if (!existing || existing.owner_email !== email)
                            return [2 /*return*/, reply.code(403).send({ message: 'Δεν έχετε δικαίωμα' })];
                        return [2 /*return*/, prisma_js_1.default.petLocation.update({ where: { id: req.params.id }, data: req.body })];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!existing || existing.owner_email !== email)
                            return [2 /*return*/, reply.code(403).send({ message: 'Δεν έχετε δικαίωμα' })];
                        return [4 /*yield*/, prisma_js_1.default.petLocation.delete({ where: { id: req.params.id } })];
                    case 2:
                        _a.sent();
