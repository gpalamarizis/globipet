...
const s = StyleSheet.create({
  ...
  petAvatar: { width: 60, height: 60, borderRadius: 18, backgroundColor: 'transparent', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', flexShrink: 0 },
  ...
  genderBtnActive: { borderColor: O, backgroundColor: 'transparent' },
